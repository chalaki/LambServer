...
# copy files
kubectl cp  .\NodeApps\data\server.js ${NODE_PODNAME}:/server.js
kubectl cp  .\NodeApps\data\server.sh ${NODE_PODNAME}:/server.sh
kubectl cp  .\NodeApps\index.js ${NODE_PODNAME}:/index.js
